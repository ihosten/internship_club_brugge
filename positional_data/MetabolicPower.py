...
class MetabolicPowerModel(BaseModel):
    ...
    subsequently be queried by calling the corresponding methods:
        ...
        - Cumulative Metabolic Power --> :func:`~MetabolicPowerModel.cumulative_metabolic_power`
        - Frame-wise Equivalent Distance --> :func:`~MetabolicPowerModel.equivalent_distance`
        - Cumulative Equivalent Distance --> :func:`~MetabolicPowerModel.cumulative_equivalent_distance`
